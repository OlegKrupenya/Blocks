 ...
 * Date: 13.10.13
 */
public class LFigureRotationManager implements RotationManager {
    ...
    public void rotate(Figure figure, Field field) {
        ...
        if (state == RotationState.HORIZONTAL && isPossibleToRotateVertically(figure, field)) {
            ...
            data[firstCell.getI() - 2][firstCell.getJ() + 1] = new Cell(firstCell.getI() - 2, firstCell.getJ() + 1,
                    Field.ONE);
            ...
            data[secondCell.getI() - 2][secondCell.getJ() + 1] = new Cell(secondCell.getI() - 2, secondCell.getJ() + 1,
                    Field.ONE);
            secondCell.setI(secondCell.getI() - 2);
            ...
            data[thirdCell.getI() - 1][thirdCell.getJ() - 2] = new Cell(thirdCell.getI() - 1, thirdCell.getJ() - 2,
                    Field.ONE);
            thirdCell.setI(thirdCell.getI() - 1);
            thirdCell.setJ(thirdCell.getJ() - 2);

            Cell fourthCell = cells.get(3);
            data[fourthCell.getI()][fourthCell.getJ()] = new Cell(fourthCell.getI(), fourthCell.getJ(), Field.ZERO);
            data[fourthCell.getI() - 1][fourthCell.getJ() - 2] = new Cell(fourthCell.getI() - 1, fourthCell.getJ() - 2,
                    Field.ONE);
            fourthCell.setI(fourthCell.getI() - 1);
            fourthCell.setJ(fourthCell.getJ() - 2);
    ...
    private boolean isPossibleToRotateBackHorizontally(Figure figure, Field field) {
        ...
        List<Cell> cells = figure.getCells();
        Cell firstCell = cells.get(0);
        if (firstCell.getJ() - 1 < 0 || data[firstCell.getI()][firstCell.getJ() - 1].getData() == Field.ONE
                || data[firstCell.getI() + 1][firstCell.getJ() - 1].getData() == Field.ONE) {
            canRotate = false;
        }
        return canRotate;
    }
    ...
    private boolean isPossibleToRotateBackVertically(Figure figure, Field field) {
        ...
        List<Cell> cells = figure.getCells();
        Cell fourthCell = cells.get(3);
        if (fourthCell.getI() + 2 > 19 || data[fourthCell.getI() + 2][fourthCell.getJ()].getData() == Field.ONE
    ...
    private boolean isPossibleToRotateHorizontally(Figure figure, Field field) {
        ...
        List<Cell> cells = figure.getCells();
        Cell secondCell = cells.get(1);
        if (secondCell.getJ() + 1 > 9 || data[secondCell.getI()][secondCell.getJ() + 1].getData() == Field.ONE
                || data[secondCell.getI() - 1][secondCell.getJ() + 1].getData() == Field.ONE) {
            canRotate = false;
        }
        return canRotate;
    }
    ...
    private boolean isPossibleToRotateVertically(Figure figure, Field field) {
        ...
        if (data[fourthCell.getI() - 1][fourthCell.getJ()].getData() == Field.ONE
                || data[fourthCell.getI() - 1][fourthCell.getJ() - 1].getData() == Field.ONE) {
            canRotate = false;
        }
        return canRotate;
    }
